...
function pie()
{
    ...
    print "      Creado por Javier Ibarra\n";
    print "    </p>\n";
    print "\n";
    print "  </footer>\n";
}
...
function cabecera($texto, $menu)
{
    ...
    if ($menu == MENU_PRINCIPAL) {
        print "        <li><a href='listar.php'>Listar registro</a></li>\n";
        print "        <li><a href='borrar-1.php'>Borrar registros</a></li>\n";
        print "        <li><a href='borrar-todo-1.php'>Borrar todo</a></li>\n";
        print "        <li><a href='modificar-1.php'>Modificar</a></li>\n";
        print "        <li><a href='insertar-1.php'>Insertar registro</a></li>\n";
...
function borraTodo()
{
    ...
    if (!$pdo->query($consulta)) {
        ...
        print "    <p>Base de datos $cfg[mysqlDatabase] borrada correctamente (si existía).</p>\n";
    }
    print "\n";
